...
export const columns = [
  ...
  { field: 'type', headerName: 'Tür', width: 150 },
  { field: 'description', headerName: 'Açıklama', width: 150 },
  { field: 'beginTime', headerName: 'Başlama Tarihi', width: 150, renderCell: (e) => <div>{new Date(e.value).toLocaleString('tr')}</div> },
  { field: 'endTime', headerName: 'Bitiş Tarihi', width: 150, renderCell: (e) => <div>{new Date(e.value).toLocaleString('tr')}</div> },
