...
function Create() {
    ...
    async function saveFormData() {
        ...
        if ([200,201].includes(result?.status)) {
            ...
            closeDrawer()
            NotificationManager.success("Rol İzin İlişkisi başarılı bir şekilde kayıt edildi")
        } else {
            NotificationManager.error("Rol İzin İlişkisi kayıt edilirken bir hata ile karşılaşıldı")
        }
