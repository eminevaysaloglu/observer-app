...
import { columns } from '../../constants/notification-types/table_columns_data'
import notificationTypesServices from '../../service';
...
function NotificationTypes() {
  ...
  async function getData() {
    ...
    const result = await notificationTypesServices.getNotificationTypes(payload)
